// Made an array of questions to loop through one by one

var questions = [{
    
      title: "1. Which one is a looping structure in JavaScript?",
    ...
    {
      title: "4. Boolean operators that can be used in JavaScript include:",
      choices: [
        "'And' Operator &&",
        "'Or' Operator ||",
        "'Not' Operator !",
    ...
    {
      title: "6. What is the data type of variables in JavaScript?",
      choices: [
        "Object data types",
        "Function data type",
        "None of the above",
    ...
    {
      title: "11. What is the type of Pop up boxes available in JavaScript?:",
